...
# Kullanici yeni Supabase'e gecmis. Verdent Auth proxy'si iptal.
...
new_key = r"SUPABASE_PUBLISHABLE_KEY = os.environ.get('SUPABASE_PUBLISHABLE_KEY', 'sb_publishable_r2tfnmKF3dq_I1YkqGi-Bw_O38IUlEj----sb_publishable_RP_ouZJiDHK_PA_3o1dmfg_G5BgAuzl')"
